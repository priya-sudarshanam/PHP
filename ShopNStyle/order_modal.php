    ...
    <div id="add<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            ...
            <div class="span3">
                ...
                <div class="langah">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['PName'] ?></div>

                <div class="alert alert-danger"> <p>&nbsp;&nbsp;&nbsp;&nbsp;Price:</p></div>
                <div class="langah">&nbsp;&nbsp;&nbsp;&nbsp;P&nbsp;<?php echo $row['PPrice'] ?></div>
                <div class="alert alert-danger"> <p>&nbsp;&nbsp;&nbsp;&nbsp;Quantity:</p></div>
                <p><input id="cnet" class="span1" max="<?php echo $row['PPrice'] * $row['Quantity']; ?>" type="number" name="quantity" value="1" required></p>
				<p>In stock Item <span class="badge badge-warning"><?php echo $row['PPrice'] * $row['Quantity']; ?></span></p>
				<br>
...
<div id="<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <div class="span3">
            ...
            <div class="langah">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['PDescription'] ?></div>
