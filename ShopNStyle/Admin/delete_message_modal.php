                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                         ...
                                         <div class="modal-body">
                                            <div class="alert alert-danger">Are you Sure you Want to <strong>Delete &nbsp;</strong> <?php echo $row['name']; ?>'s Message?</div>
                                        </div>
                                        <div class="modal-footer">
                                            <a class="btn btn-danger" href="delete_message.php<?php echo '?id=' . $message_id; ?>" ><i class="icon-check"></i>&nbsp;Yes</a>
