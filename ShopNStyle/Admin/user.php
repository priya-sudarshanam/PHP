			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
							 ...
							 <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#add_user">
                              Add User
                            </button>
                        ...
                        if (isset($_POST['add'])) {
                            ...
                            $user_exists = check_user_exists($username);
                             if ($user_exists) {
                                echo "<i class='fa fa-exclamation-circle fa-2x text-error'>Username: '.$username.'exists.</i>";
                            }
                            else {
                                $roleid = load_role_id($rolename);
                                $success = add_new_user($firstname, $lastname, $username, $password, $roleid);
                                if ($success) {
                                ...
                                <tbody>
                                    ...
                                    foreach ($rows as $row) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td width="80">
                                                <a href="#delete_user<?php echo $user_id; ?>" role="button"
                                                   data-target = "#delete_user<?php echo $user_id;?>"
