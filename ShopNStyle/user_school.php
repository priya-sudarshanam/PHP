                            ...
                            <li class="span3">
                                <div class="thumbnail">
                                    ...
                                    <a href="#<?php echo $id; ?>" data-toggle="modal"><img
                                                src="admin/<?php echo $row['Location'] ?>" class="img-rounded" alt=""
                                    ...
                                    <?php if ($total_qty > 0) { ?>
                                        <a href="#add<?php echo $id; ?>" data-toggle="modal" class="btn btn-success"><i
                                                    class="icon-shopping-cart icon-large"></i>&nbsp;Add to Cart</a>
                                    <?php } else { ?>
                                    ...
                                    if (isset($_POST['order'])) {
                                        ...
                                        $success = save_to_order_details($member_id,$quantity,$product_id,$price,'Pending','creditcard');
                                        if ($success) {
